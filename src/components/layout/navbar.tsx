  ...
  return (
    <>
      <style>{`
        ...
        .kl-nav-links a{font-family:'DM Sans','Instrument Sans',system-ui,sans-serif;font-size:14px;color:#536471;text-decoration:none;font-weight:500;transition:color .15s;white-space:nowrap}
