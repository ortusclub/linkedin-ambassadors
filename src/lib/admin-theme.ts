...
export const ADMIN_THEMES: Record<AdminTheme, Record<string, string>> = {
  dark: {
    ...
    "--st-construct-bg": "rgba(167,139,250,.16)", "--st-construct-fg": "#c4b5fd",
    ...
    "--band": "rgba(255,255,255,.02)", "--avatar-bg": "rgba(79,140,255,.14)", "--avatar-fg": "#7eb0ff", "--danger-border": "rgba(248,113,113,.6)", "--link-bg": "rgba(79,140,255,.1)", "--orange": "#f59e0b", "--danger": "#f87171", "--st-unreach-bg": "rgba(251,146,60,.16)", "--st-unreach-fg": "#fb923c", "--toggle-off": "#2a3346",
  },
  light: {
    ...
    "--st-construct-bg": "#ece9fe", "--st-construct-fg": "#6d28d9",
    ...
    "--band": "#f8f9fb", "--avatar-bg": "#e6effe", "--avatar-fg": "#1d4ed8", "--danger-border": "#e0908f", "--link-bg": "#eef3fe", "--orange": "#d97706", "--danger": "#dc2626", "--st-unreach-bg": "#fdecd8", "--st-unreach-fg": "#c2410c", "--toggle-off": "#cbd2dc",
  },
};
