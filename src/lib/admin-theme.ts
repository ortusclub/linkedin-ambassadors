...
export const ADMIN_THEMES: Record<AdminTheme, Record<string, string>> = {
  dark: {
    ...
    "--band": "rgba(255,255,255,.02)", "--avatar-bg": "rgba(79,140,255,.14)", "--avatar-fg": "#7eb0ff", "--danger-border": "rgba(248,113,113,.6)", "--link-bg": "rgba(79,140,255,.1)", "--orange": "#f59e0b", "--danger": "#f87171",
  },
  light: {
    ...
    "--band": "#f8f9fb", "--avatar-bg": "#e6effe", "--avatar-fg": "#1d4ed8", "--danger-border": "#e0908f", "--link-bg": "#eef3fe", "--orange": "#d97706", "--danger": "#dc2626",
  },
};
