...
export const blogPosts: BlogPost[] = [
  {
    ...
    description: "LinkedIn caps weekly connection requests at 100-200. Here's exactly how the limits work, what triggers restrictions, and proven strategies to scale outreach without getting banned.",
    date: "2026-04-01",
    readTime: "8 min read",
    category: "LinkedIn Limits",
    content: `
...
`,
  ...
  {
    slug: "power-of-linkedin-outreach-campaigns",
    title: "The Power of LinkedIn Outreach Campaigns: Why It's Still the #1 B2B Channel",
    description: "LinkedIn outreach converts 3-5x better than cold email. Here's why LinkedIn campaigns are so effective for B2B sales and how to run them at scale.",
    date: "2026-04-01",
    readTime: "7 min read",
...
**Day 1:** View their profile (they'll see you visited)
**Day 2:** Like or comment on one of their recent posts
**Day 3:** Send a connection request with a personalised note (reference their post, mutual connection, or something specific)
**Day 5 (after acceptance):** Send a value-first message — share an insight, article, or case study relevant to them
**Day 8:** Follow up with a specific question about their challenges
**Day 12:** Make your ask — a meeting, demo, or call
...
`,
  ...
  {
    slug: "linkedin-open-profile-campaigns",
    title: "LinkedIn Open Profile Campaigns: The Free Outreach Strategy Most Teams Miss",
    description: "Open Profile lets you message LinkedIn users for free — no connection needed, no InMail credits. Here's how to find Open Profiles and run campaigns at scale.",
    date: "2026-04-01",
    readTime: "6 min read",
    category: "LinkedIn Strategy",
    content: `
...
| Factor | Open Profile Message | InMail |
|--------|---------------------|--------|
| Cost | Free | $5-10 per credit |
| Inbox placement | Regular inbox | InMail tab (often ignored) |
| Response rate | 15-30% | 10-20% |
| Character limit | Standard message limit | 1,900 characters |
| Requires Sales Nav | No (to send) | Yes |
| Monthly cap | Subject to messaging limits | 50-150/month depending on plan |
...
`,
  ...
  {
    slug: "linkedin-cracking-down-ai-automation-2026",
    title: "LinkedIn Is Cracking Down on AI and Automation in 2026 — Here's What You Need to Know",
    description: "LinkedIn is using AI to detect and ban automated outreach. Here's what's changed, what triggers bans, and how to keep running outreach campaigns safely.",
    date: "2026-04-01",
    readTime: "9 min read",
...
Your account is temporarily limited. You can't send connection requests or messages for 24-72 hours. You get a warning notification.

**Level 2 — Identity verification:**
LinkedIn requires you to verify your identity with a government ID or phone number. If your account uses a fake name or you can't verify, you're done.

**Level 3 — Feature restriction:**
Your messaging, search, and connection request features are permanently restricted. The account is essentially useless for outreach.

**Level 4 — Account ban:**
Full suspension. Your profile is deactivated. Any new account you create from the same device/IP may be immediately flagged.
...
| Activity | Daily Safe Limit | Weekly Safe Limit |
|----------|-----------------|-------------------|
| Connection requests | 20-25 | 100-150 |
| Messages (to connections) | 50-75 | 250-400 |
| Profile views | 80-100 | 400-500 |
| Search queries | 30-50 | 150-250 |
