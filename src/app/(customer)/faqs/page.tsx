  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Pricing depends on the account's seniority, connections, and whether Sales Navigator is included. Most accounts fall between $45 and $110 per month, with Sales Navigator available as a +$70/mo add-on, and you'll see the exact price before you commit.",
      },
      {
