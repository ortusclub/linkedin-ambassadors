          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-5 md:grid-cols-2">
              ...
              >
                ...
                <h3 className="mt-3 text-lg font-semibold text-gray-900">Get Your Profile Evaluated</h3>
                <p className="mt-2 text-sm text-gray-500 leading-relaxed">Share your LinkedIn details and we&apos;ll assess your profile value. Currently in beta testing.</p>
                <div className="mt-5">
                  <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-blue-600 group-hover:gap-2.5 transition-all">
                    Start Evaluation
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
              ...
              <Card>
                <CardContent className="py-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <a href="https://t.me/klabber_support_bot" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 rounded-lg border border-gray-200 p-3 hover:bg-blue-50 hover:border-blue-200 transition-all">
