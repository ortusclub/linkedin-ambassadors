          ...
          <section id="faq" style={{ background: "#fff", padding: "64px 24px 72px" }}>
            ...
            <div style={{ maxWidth: 820, margin: "0 auto", display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                { q: "Do I have to share my password?", a: "Renters never see your password — that's the key part. To keep the account secure and running, we hold the login ourselves and set our email as the recovery contact, so we can handle any security checks or 2FA on your behalf. It's stored securely, never shared with renters, and you can change it or withdraw your account at any time." },
