      ...
      <section style={{ padding: "48px 24px 80px" }}>
        <div className="g-wrap">
          <div className="g-card" style={{ textAlign: "center", padding: "40px 26px" }}>
            ...
            <p style={{ fontSize: 14, color: "#8899A6", margin: "0 0 22px" }}>Telegram <a href="https://t.me/linkedvelocity_support_bot" target="_blank" rel="noopener noreferrer" style={{ color: "#0A66C2", fontWeight: 700, textDecoration: "none" }}>@linkedvelocity_support_bot</a> &nbsp;·&nbsp; Response within a few hours during business hours</p>
