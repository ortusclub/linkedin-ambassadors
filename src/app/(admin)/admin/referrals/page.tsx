...
export default function AdminReferralsPage() {
  ...
  const printFlyers = () => {
    ...
    const flyers = referrers.map((r) => {
      ...
      return `<div class="sheet"><div class="top"><div class="wm">&#10022; LinkedVelocity</div><div class="badge">For students &amp; professionals</div><h2>Get paid for your <span>LinkedIn</span></h2><p>Earn every month just by lending us your account. It stays yours &mdash; take it back anytime.</p></div><div class="body"><div class="benefits"><div class="b"><b>&#8369;1,000</b><span>to start</span></div><div class="b feat"><b>&#8369;500</b><span>every month</span></div><div class="b"><b>&#8776;&#8369;7,000</b><span>first year</span></div></div><div class="wt">Why people say yes</div><div class="wl"><div><i>&#10003;</i><span>Your <b>name &amp; photo never change</b> &mdash; it stays your profile</span></div><div><i>&#10003;</i><span><b>Take it back anytime</b>, cancel anytime &mdash; no penalties</span></div><div><i>&#10003;</i><span>We only work with <b>vetted, legitimate businesses</b></span></div><div><i>&#10003;</i><span>Your <b>password is never shared</b> with anyone</span></div><div><i>&#10003;</i><span>Not sure? <b>Try it with just one account</b> and see how it works</span></div></div><div class="qrwrap"><img class="qr" src="${qr}" alt="QR"/><div class="qrt"><div class="lead">Scan to sign up</div><div class="or">&hellip; or just type this link:</div><div class="url">${shortLink}</div><div class="code">Referred by <b>${r.name}</b> &middot; code <b>${r.slug}</b></div></div></div></div><div class="bot">18+ &middot; any LinkedIn account (new is fine) &middot; payment after setup, never cash on the spot</div></div>`;
    }).join("");
